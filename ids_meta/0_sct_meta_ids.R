...
# Add lymphocyte counts and bmi they went missing somehow
...
save.image(file.path(results_dir, "metadata_july23.RData"))
write.csv(covar, file = file.path(meta_dir, "sct_all_covars_Jul23.csv"), row.names = F)
