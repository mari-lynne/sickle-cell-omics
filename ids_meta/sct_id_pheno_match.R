...
#1) Gather all IDs and phenotype information for SCT rna-seq data
...
# Orginal id files and link files copied from /fh/scratch/delete90/kooperberg_c/sct_rnaseq
...
sct_pheno <- sct_pheno %>% select(rnaseq_ids, commonid, subject_id, age, ethnic, as311.y, as315.y, baa23.y, sct, Whills, flagged_seq_qc_metric, pick_plate_1_indicates_which_samples_were_prepped_together, pick_plate_2_repeat)
